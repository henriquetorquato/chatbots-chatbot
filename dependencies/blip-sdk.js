	    ...
	    _createClass(Client, [{
	        ...
	        value: function _initializeClientChannel() {
	            ...
	            this._clientChannel.onMessage = function (message) {
	                ...
	                var hasError = _this2._messageReceivers.some(function (receiver) {
	                ...
	                if (!hasError && shouldNotify && _this2._application.notifyConsumed) {
	                    _this2.sendNotification({ id: message.id, to: message.from, event: _limeJs2.default.NotificationEvent.CONSUMED });
	                }
	            };
	        ...
	        value: function sendCommand(command) {
	            ...
	            return _bluebird2.default.race([new _bluebird2.default(function (resolve, reject) {
	                _this3._commandResolves[command.id] = function (c) {
	                    if (!c.status) return;
	                    ...
	                    delete _this3._commandResolves[command.id];
	                };
	            }), new _bluebird2.default(function (resolve, reject) {
	                setTimeout(function () {
	                    if (!_this3._commandResolves[command.id]) return;
	        ...
	        value: function addMessageReceiver(predicate, callback) {
	            ...
	            return function () {
	                return _this4._messageReceivers = _this4._messageReceivers.filter(function (r) {
	        ...
	        value: function addNotificationReceiver(predicate, callback) {
	            ...
	            return function () {
	                return _this5._notificationReceivers = _this5._notificationReceivers.filter(function (r) {
	                    return r.predicate !== predicate && r.callback !== callback;
	                });
	            };
	        }
