...
exports.BlipChat = undefined;

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

var _BlipChatWidget = __webpack_require__(127);

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var DEV_AUTH = 'Dev';
var GUEST_AUTH = 'Guest';

var ENTER_EVENT = 'OnEnter';
var LEAVE_EVENT = 'OnLeave';
var LOAD_EVENT = 'OnLoad';

var BlipChat = exports.BlipChat = function () {
  function BlipChat() {
    _classCallCheck(this, BlipChat);

    this.events = {};
  }

  _createClass(BlipChat, [{
    key: 'withAppKey',
    value: function withAppKey(appkey) {
      this.appKey = appkey;
      return this;
    }
  }, {
    key: 'withButton',
    value: function withButton(buttonConfig) {
      this.buttonConfig = buttonConfig;
      return this;
    }
  }, {
    key: 'withAuth',
    value: function withAuth(authConfig) {
      this.authConfig = authConfig;
      return this;
    }
  }, {
    key: 'withEventHandler',
    value: function withEventHandler(name, handler) {
    ...
    key: 'withEnvironment',
    value: function withEnvironment(environment) {
    ...
    value: function build() {
      this.widget = new _BlipChatWidget.BlipChatWidget(this.appKey, this.buttonConfig, this.authConfig, this.target, this.events, this.environment || "production");
    }
  }, {
    key: 'destroy',
    value: function destroy() {
      ...
      if (this.widget && this.target) {
        ...
        this.widget.blipChatContainer.parentElement.removeChild(this.widget.blipChatContainer);
      }
      this.widget = null;
    }
  }, {
...
var _StorageService = __webpack_require__(132);
...
var _BlipChat = __webpack_require__(91);
...
var BlipChatWidget = exports.BlipChatWidget = function () {
  function BlipChatWidget(appKey, buttonConfig, authConfig, target, events, environment) {
    _classCallCheck(this, BlipChatWidget);

    self = this;
    self.appKey = appKey;
    self.buttonColor = buttonConfig.color;
    self.buttonIcon = buttonConfig.icon || _brandLogo2.default;
    ...
    self.CHAT_URL = _Constants2.default.CHAT_URL_LOCAL;
    if (environment === 'homolog') {
      self.CHAT_URL = _Constants2.default.CHAT_URL_HMG;
    } else if (environment === 'production') {
      self.CHAT_URL = _Constants2.default.CHAT_URL_PROD;
    }
    ...
    _StorageService2.default.processLocalStorageExpires();

    self._onInit();
  }

  _createClass(BlipChatWidget, [{
    key: '_onInit',
    value: function _onInit() {
      var rendered = self._render(_chat2.default, this);
      ...
      if (!self.target) {
        ...
        document.getElementById('blip-chat-open-iframe').addEventListener('click', self._openChat);
      }
    ...
    key: '_createDiv',
    value: function _createDiv(selector) {
    ...
    value: function _render(template) {
      ...
      return template.replace(/{{([^{}]*)}}/g, function (replaced, bind) {
        var key = bind;
    ...
    key: '_resizeElements',
    value: function _resizeElements() {
      var blipFAB = document.getElementById('blip-chat-open-iframe');
      var blipChatIframe = document.getElementById('blip-chat-iframe');
      var screenHeight = window.outerHeight - 250;
    ...
    value: function _parseAuthConfig(authConfig) {
      if (!authConfig) {
        return { authType: _BlipChat.BlipChat.GUEST_AUTH };
      }

      authConfig.userPassword = authConfig.userPassword !== undefined && !(0, _Validators.isBase64)(authConfig.userPassword) ? window.btoa(authConfig.userPassword) : authConfig.userPassword;

      var _window$atob$split = window.atob(self.appKey).split(':'),
          _window$atob$split2 = _slicedToArray(_window$atob$split, 1),
          identifier = _window$atob$split2[0];
    ...
    key: '_openChat',
    value: function _openChat(event) {
      var blipChatIframe = document.getElementById('blip-chat-iframe');
      var blipChatIcon = document.getElementById('blip-chat-icon');
      ...
      if (!blipChatIframe.classList.contains('blip-chat-iframe-opened')) {
        if (!self.isOpen) {
          ...
          var userAccount = self._getObfuscatedUserAccount();
          blipChatIframe.contentWindow.postMessage({ code: _Constants2.default.START_CONNECTION_CODE, userAccount: userAccount }, self.CHAT_URL);
          self.isOpen = true;
        }
        blipChatIframe.classList.add('blip-chat-iframe-opened');

        blipChatIcon.src = _close2.default;
    ...
    value: function _onReceivePostMessage(message) {
      switch (message.data.code) {
        case _Constants2.default.CHAT_READY_CODE:
          if (!self.target) {
            // Chat presented on widget
            var button = document.getElementById('blip-chat-open-iframe');
        ...
        case _Constants2.default.CREATE_ACCOUNT_CODE:
          var data = window.atob(message.data.userAccount);
          _StorageService2.default.setToLocalStorage(_Constants2.default.USER_ACCOUNT_KEY, JSON.parse(data), _Constants2.default.COOKIES_EXPIRATION);
          break;

        case _Constants2.default.CHAT_CONNECTED_CODE:
    ...
    value: function _getObfuscatedUserAccount() {
      if (!self.authConfig || self.authConfig.authType === _Constants2.default.GUEST_AUTH) {
        return _StorageService2.default.getFromLocalStorage(_Constants2.default.USER_ACCOUNT_KEY);
      } else if (self.authConfig.authType === _Constants2.default.DEV_AUTH) {
    ...
    value: function sendMessage(content) {
      var blipChatIframe = document.getElementById('blip-chat-iframe');
      blipChatIframe.contentWindow.postMessage({ code: _Constants2.default.SEND_MESSAGE_CODE, content: content }, self.CHAT_URL);
    }
  }, {
    key: 'destroy',
    value: function destroy() {
...
module.exports = "data:image/svg+xml;base64,"
...
var CHAT_URL_LOCAL = 'http://localhost:8082/';
var CHAT_URL_HMG = 'https://hmg-chat.blip.ai/';
var CHAT_URL_PROD = 'https://chat.blip.ai/';

var CHAT_READY_CODE = 'RequestCookie';
var START_CONNECTION_CODE = 'BlipSdkStartConnection';
var CREATE_ACCOUNT_CODE = 'CreateAccount';
var CHAT_CONNECTED_CODE = 'ChatConnected';
var SEND_MESSAGE_CODE = 'SendMessage';
var USER_ACCOUNT_KEY = 'blipSdkUAccount';

var COOKIES_EXPIRATION = 8.64e7;
var DEV_AUTH = 'Dev';
var GUEST_AUTH = 'Guest';

var CONSTANTS = {
  CHAT_URL_LOCAL: CHAT_URL_LOCAL,
  CHAT_URL_HMG: CHAT_URL_HMG,
  CHAT_URL_PROD: CHAT_URL_PROD,
  CHAT_READY_CODE: CHAT_READY_CODE,
  START_CONNECTION_CODE: START_CONNECTION_CODE,
  CHAT_CONNECTED_CODE: CHAT_CONNECTED_CODE,
  SEND_MESSAGE_CODE: SEND_MESSAGE_CODE,
  USER_ACCOUNT_KEY: USER_ACCOUNT_KEY,
  CREATE_ACCOUNT_CODE: CREATE_ACCOUNT_CODE,
  COOKIES_EXPIRATION: COOKIES_EXPIRATION,
  DEV_AUTH: DEV_AUTH,
...
var StorageService = function () {
  ...
  _createClass(StorageService, null, [{
    ...
    value: function setToLocalStorage(name, value, expires) {
      if (this._supportsLocalStorage()) {
    ...
    value: function processLocalStorageExpires() {
      try {
        ...
        for (var i = 0, j = window.localStorage.length; i < j; i++) {
          try {
            var currentValue = window.localStorage.getItem(window.localStorage.key(i));
        ...
        for (var _i = toRemove.length - 1; _i >= 0; _i--) {
          window.localStorage.removeItem(toRemove[_i]);
        }
      } catch (e) {}
    }
  }]);
